 ...
 * @since 2.0
 */
public class ProxyAwareLocalVariableTableParameterNameDiscoverer implements ParameterNameDiscoverer
{
  private static Log logger = LogFactory.getLog( ProxyAwareLocalVariableTableParameterNameDiscoverer.class );
  ...
  public String[] getParameterNames( Method method )
  {
    ...
    if( paramNames == null )
    {
      ...
      catch( IOException ex )
      {
        ...
        {
          logger.debug( "IOException whilst attempting to read '.class' file for class [" + method.getDeclaringClass().getName()
  ...
  public String[] getParameterNames( Constructor ctor )
  {
    ...
    if( paramNames == null )
    {
      ...
      catch( IOException ex )
      {
        ...
        if( logger.isDebugEnabled() )
        {
          logger.debug( "IOException whilst attempting to read '.class' file for class [" + ctor.getDeclaringClass().getName()
  ...
  {
    this.parameterNamesCache.clear();
    this.classReaderCache.clear();
  }
